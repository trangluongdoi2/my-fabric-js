import type { TOriginX, TOriginY, TRadian } from './types';
import { util } from 'fabric';
import type saveObjectTransform from util.saveObjectTransform;
import type { 
  StaticCanvas,
  IText,
  Canvas,
  Group,
  FabricObject as StaticFabricObject,
  Point,
  Control,
 } from 'fabric';
...
export type CanvasEvents = StaticCanvasEvents &
  ...
  export type ScaleTransform = Transform & {
    gestureScale?: number;
    signX?: number;
    signY?: number;
  };
  
  export type ScaleBy = TAxis | 'equally' | '' | undefined;
